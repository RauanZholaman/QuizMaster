  ...
  return (
    <div className="page-container" style={{ padding: '40px', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <section style={{ marginBottom: '20px' }}>
        ...
        <p>
          QuizMaster ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by QuizMaster.
        </p>
      </section>
      ...
      <section style={{ marginBottom: '20px' }}>
        ...
        <p>
          <strong>Personal Information:</strong> When you register for an account, we collect personal information such as your name, email address, and role (student or educator).
        </p>
        <p>
      ...
      <section style={{ marginBottom: '20px' }}>
        <h2>9. Contact Us</h2>
        <p>
          If you have any questions about this Privacy Policy, please contact us at privacy@quizmaster.com.
        </p>
      </section>
    </div>
  );
